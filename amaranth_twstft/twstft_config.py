...
def arg_parser():
    ...
    parser.add_argument('--prn', type=int, metavar='N', help='save a PRN of N bits generated by given taps')
...
def main():
    ...
    if args.prn:
        if not args.taps_a:
            parser.error('--prn requiere taps to be specified (--taps-a / --taps-b)')
        write_prn_seq(args.prn, args.taps_a, args.taps_b)
