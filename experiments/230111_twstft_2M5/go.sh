...
/root/stat /tmp/fichier.bin > /root/data/$ladatedeb.stat
mv /tmp/fichier.bin /root/data/$ladatedeb.bin
mv /tmp/$ladate.log /root/data
touch /root/data/$ladatefin.end
touch /root/data/$ladate.debut
scp /root/data/1* jmfriedt@10.10.135.15:/home/jmfriedt
mv /root/data/1* /root/data/archive
# cd /tmp
# time /root/app /root/data/$ladatedeb.bin /root/data/code/code2500000_bitlen22_taps3.bin
# mv /tmp/myfile.mat /root/data/$ladatedeb.mat
swapoff -a
swapon -a
fi
