...
% codelocation='/home/jmfriedt/sdr/SATRE/amaranth_twstft/experiments/221207_twoway_codes/codes/'
codelocation='/home/ngallone/amaranth_twstft/experiments/221207_twoway_codes/codes/'

dirlist=dir([datalocation,'/16744*.bin']);
    ...
    if (longueur==fs*4)  
      ...
      do
        ...
        if (10*log10(SNR1i(p)+SNR1r(p))>-30)
           if ((indice1(p)!=1) && (indice1(p)!=2) && (indice1(p)!=length(code)))
