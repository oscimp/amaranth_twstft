...
The File Source on the bottom left of the flowchart is assumed to hold the
...
correlating in the Fourier domain. Because the Fourier transforms might exceed
...
generated by the FPGA or if the FPGA has not been powered up and is not generating any
signal.
